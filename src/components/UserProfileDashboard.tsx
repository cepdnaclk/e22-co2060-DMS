                    ...
                    <div className="flex items-center justify-end gap-3 sm:gap-4 flex-1">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`p-2 rounded-lg transition-colors relative ${isDarkMode ? 'text-gray-300 hover:bg-gray-800' : 'text-gray-600 hover:bg-gray-100'} ${isNotifOpen ? (isDarkMode ? 'bg-gray-800' : 'bg-gray-100') : ''}`}
                                title="Notifications"
                                id="notif-btn"
                            >
                        ...
                        <div className="relative ml-1">
                            <button
                                ...
                                className={`w-8 h-8 rounded-full flex items-center justify-center border transition-all hover:ring-2 hover:ring-blue-500/50 ${isDarkMode ? 'bg-gray-800 border-gray-600 text-gray-400' : 'bg-gray-100 border-gray-300 text-gray-500'} ${isProfileOpen ? 'ring-2 ring-blue-500/50' : ''}`}
                                title="Profile"
                                id="profile-btn"
                            >
                        ...
                        <div className={`rounded-xl shadow-sm border p-6 flex flex-col ${cardBgClass}`}>
                            ...
                            <div className="mt-6 flex flex-col gap-3">
                                ...
                                <button
                                    ...
                                    className={`w-full py-2 rounded-lg text-sm font-semibold transition-colors border ${isDarkMode ? 'bg-green-500/10 text-green-400 border-green-500/20 hover:bg-green-500/20' : 'bg-green-50 text-green-700 border-green-200 hover:bg-green-100'}`}
                                >
                                    Edit Profile
                                </button>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {user.socialLinks?.twitter && (
                                    <a href={user.socialLinks.twitter} className={`p-2 rounded-lg transition-colors ${hoverBgClass} ${textMutedClass} hover:text-current`} title="X (Twitter)" target="_blank" rel="noreferrer">
