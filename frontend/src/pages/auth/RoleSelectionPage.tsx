...
import { Mic, Scale, Briefcase, ArrowRight } from 'lucide-react';
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-2.5 mb-6">
            <img src={logo} alt="VIVAATHI logo" className="w-12 h-12 rounded-2xl object-cover shadow-xl" />
            <span className="font-black text-4xl tracking-[0.18em] uppercase bg-gradient-to-r from-cyan-300 via-blue-300 to-violet-400 bg-clip-text text-transparent">
              VIVAATHI
            </span>
          </div>
